...
const TransactionsTable = ({ transactions }: TransactionTableProps) => {
  return (
    ...
    <TableCell>Rs.110</TableCell>
    <TableCell>Success</TableCell>
    <TableCell >wed,Apr-24-2024</TableCell>
    <TableCell>Online</TableCell>
    <TableCell>Payment</TableCell>
     </TableRow>
     <TableRow>
     <TableCell className="font-medium">INV002</TableCell>
    <TableCell>Rs.210</TableCell>
    <TableCell>Success</TableCell>
    <TableCell >Tue,Feb-14-2024</TableCell>
    <TableCell>Online</TableCell>
...
//     </TableRow>
//     <TableRow>
//       <TableCell className="font-medium">INV042</TableCell>
//       <TableCell>Rs.900</TableCell>
//       <TableCell>Success</TableCell>
//       <TableCell >Fri,Nov-15-2024</TableCell>
